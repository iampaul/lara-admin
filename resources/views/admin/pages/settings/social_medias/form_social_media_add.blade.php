...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{{ admin_url('settings/addSocialMedia') }}">
            {{ csrf_field() }}
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" id="social_link" name="social_link" class="form-control validate[required]" placeholder="Link" value="{{ old('social_link', '') }}" >
                  </div>
                </div>                
