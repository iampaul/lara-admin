...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{{ admin_url('settings/addEmailTemplate') }}">
            {{ csrf_field() }}
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3 label-control" for="slug">Subject</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <textarea id="message" name="message" class="cleditor form-control validate[required]">
                      <?php echo old('message')?old('message'): ''; ?>
                    </textarea>
                  </div>
                </div>                
