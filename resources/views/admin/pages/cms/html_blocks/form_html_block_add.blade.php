...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{{ admin_url('pages/addHtmlBlock') }}">
            {{ csrf_field() }}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <textarea id="description" name="description" class="cleditor form-control validate[required]">
                      <?php echo old('description')?old('description'): ''; ?>
                    </textarea>
                  </div>
                </div>                
