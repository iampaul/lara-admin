...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{{ admin_url('pages/addBanner') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="title" name="title" class="form-control validate[required]" placeholder="Title" value="{{ old('title', '') }}" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <textarea id="description" name="description" class="form-control validate[required]"><?php echo old('description')?old('description'): ''; ?></textarea>
                  </div>
                </div>
