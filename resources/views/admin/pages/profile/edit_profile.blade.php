...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{{ route('post:admin:admin:editProfile') }}">
            {{ csrf_field() }}
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="email" name="email" class="form-control validate[required]" placeholder="Email" value="{{ old('email', $admin_email ) }}" >
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="contact_number" name="contact_number" class="form-control" placeholder="Last Name" value="{{ old('contact_number', $admin->contact_number) }}" >
                    </div>
                </div>
                <div class="form-group row">
                ...
                <!-- <div class="form-group row">
                  <label class="col-md-3 label-control" for="lastname">Status</label>  
                  <div class="col-md-6">
