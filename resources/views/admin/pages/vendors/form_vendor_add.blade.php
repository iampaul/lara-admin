...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{!! admin_url('vendors/addVendor') !!}">
            {{ csrf_field() }}
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="company_name" name="company_name" class="form-control validate[required]" placeholder="Company Name" value="{{ old('company_name', '') }}" >
                    </div>
                </div>
                <div class="form-group row">
