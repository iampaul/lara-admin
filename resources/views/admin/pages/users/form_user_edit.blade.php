...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{!! admin_url('users/editUser/'.safe_b64encode($user->user_id)) !!}">
            {{ csrf_field() }}
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="email" name="email" class="form-control validate[required,custom[email]]" placeholder="Email" value="{{ old('email', $user_email) }}" >                        
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="firstname" name="firstname" class="form-control validate[required]" placeholder="First Name" value="{{ old('firstname', $user->firstname) }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 label-control" for="lastname">Last Name</label>
                    <div class="col-md-6">
                        <input type="text" id="lastname" name="lastname" class="form-control validate[required]" placeholder="Last Name" value="{{ old('lastname', $user->lastname) }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 label-control" for="contact_number">Mobile</label>
                    <div class="col-md-6">
                        <input type="text" id="mobile" name="mobile" class="form-control" placeholder="Mobile" value="{{ old('mobile', $user->mobile) }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 label-control" for="address">Address Line 1</label>
                    <div class="col-md-6">
                        <input type="text" id="address_line1" name="address_line1" class="form-control" placeholder="Address Line 1" value="{{ old('address_line1', $user->address_line1) }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 label-control" for="address">Address Line 2</label>
                    <div class="col-md-6">
                        <input type="text" id="address_line2" name="address_line2" class="form-control" placeholder="Address Line 2" value="{{ old('address_line2', $user->address_line2) }}" >
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="country" name="country" class="custom-select form-control">
                            @if($countries)
                                ...
                                <option {{ (isset($user->country) && $user->country == $country->name)?"SELECTED":"" }} value="{{ $country->name }}" data-country-id="{{ $country->country_id }}">{{ $country->name }}</option>    
                                @endforeach
                            @endif
                        </select>    
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="postcode" name="postcode" class="form-control" placeholder="Postal code" value="{{ old('postcode', $user->postcode) }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 label-control" for="landmark">Land Mark</label>
                    <div class="col-md-6">
                        <input type="text" id="landmark" name="landmark" class="form-control" placeholder="Land Mark" value="{{ old('landmark', $user->landmark) }}" >
                    </div>
                </div>  
                <div class="form-group row">
                  ...
                  <div class="d-inline-block custom-control custom-radio mr-1">
                    <input type="radio" class="custom-control-input bg-primary" name="status" id="status_active" value="ACTIVE" {{ $user->status == "ACTIVE" ? 'CHECKED' : '' }} >
                    <label class="custom-control-label" for="status_active">Active</label>
                  </div>
                  <div class="d-inline-block custom-control custom-radio mr-1">
                    <input type="radio" class="custom-control-input bg-danger" name="status" id="status_disabled" value="DISABLED" {{ $user->status == "DISABLED" ? 'CHECKED' : '' }} >
...
function getStates()
{
  var selected_state = "{{ ($user->state)?$user->state:"" }}";
...
function getCities()
{
  var selected_city = "{{ ($user->city)?$user->city:"" }}";
