...
<div class="card">
    ...
    <div class="card-body"> 
        <form class="form form-horizontal {{ (isAjaxRequest())?'ajax-form':'' }} validate-form" method="post" action="{{ admin_url('tools/editFabricCategory/'.safe_b64encode($fabric_category->category_id)) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-body">
              ...
              <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="tool_id" name="tool_id" class="custom-select form-control">
                            @if($tools)
                                ...
                                <option value="{{ $tool->tool_id }}" {{ (isset($fabric_category->tool_id) && $fabric_category->tool_id == $tool->tool_id)?"SELECTED":"" }} >{{ $tool->tool_name }}</option>    
                                @endforeach
                            @endif
                        </select>    
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="category_name" name="category_name" class="form-control validate[required]" placeholder="Category Name" value="{{ old('category_name', $fabric_category->category_name) }}" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input type="text" id="price" name="price" class="form-control validate[required,custom[number]]" placeholder="Price" value="{{ old('price', $fabric_category->price) }}" >
                    </div>
                </div>                
